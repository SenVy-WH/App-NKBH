...
import com.practice.project5.bean.UserInfo;
import com.practice.project5.database.UserDBHelper;
import com.practice.project5.util.DateUtil;
import com.practice.project5.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","学校用户", "18990724-汪昊"};
