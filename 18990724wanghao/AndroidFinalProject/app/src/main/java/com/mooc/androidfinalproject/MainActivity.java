package com.mooc.androidfinalproject;
...
import com.mooc.androidfinalproject.bean.UserInfo;
import com.mooc.androidfinalproject.database.UserDBHelper;
import com.mooc.androidfinalproject.util.DateUtil;
import com.mooc.androidfinalproject.util.ViewUtil;
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(com.mooc.androidfinalproject.MainActivity.this, mView);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) {
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.mooc.androidfinalproject.LoginForgetActivity.class);
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.mooc.androidfinalproject.SQLiteWriteActivity.class);
                startActivityForResult(intent, mRequestCode);
            }
        }
    }
